        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="glass-card p-6 text-center">
              <FaCoins className="text-3xl text-cyan-400 mx-auto mb-2" />
              <p className="text-gray-400 text-sm mb-1">{t('rewards.lp_balance')}</p>
            ...
            <div className="glass-card p-6 text-center">
              <FaChartPie className="text-3xl text-purple-400 mx-auto mb-2" />
              <p className="text-gray-400 text-sm mb-1">{t('rewards.lp_share')}</p>
              <p className="text-2xl font-bold text-white">
            ...
            <div className="glass-card p-6 text-center">
              <FaGift className="text-3xl text-green-400 mx-auto mb-2" />
              <p className="text-gray-400 text-sm mb-1">{t('rewards.claimable')}</p>
            ...
            <div className="glass-card p-6 text-center">
              <FaHistory className="text-3xl text-orange-400 mx-auto mb-2" />
              <p className="text-gray-400 text-sm mb-1">{t('rewards.current_claimable')}</p>
              <p className="text-2xl font-bold text-white">
          ...
          {/* 领取奖励卡片 */}
          <div className="glass-card p-6">
            <h3 className="text-xl font-bold text-white mb-4">{t('rewards.claim_title')}</h3>

            <div className="bg-gradient-to-r from-green-500/10 to-emerald-600/10 border border-green-500/30 rounded-lg p-6 mb-6">
              <p className="text-gray-400 text-sm mb-2">{t('rewards.current_claimable')}</p>
            ...
            {parseFloat(lpInfo.estimatedRewards) <= 0 && (
              <p className="text-gray-500 text-sm text-center mt-3">{t('rewards.no_rewards_tip')}</p>
            )}
          </div>
